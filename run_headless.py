#!/usr/bin/env python3
"""
Script para executar os testes Robot Framework em modo HEADLESS.
Este script executa todos os testes sem abrir o navegador visualmente.
"""
...
def run_headless_tests(test_file=None, output_dir=None):
    """
    Executa os testes Robot Framework em modo HEADLESS.
...
def main():
    parser = argparse.ArgumentParser(description="Executa testes Robot Framework em modo HEADLESS")
    parser.add_argument(
        "--test", "-t", 
